...
# resource "local_sensitive_file" "pri_key" {
...
# resource "local_sensitive_file" "pub_key" {
...
#     filename = "github.com/tdmithun07-jpg/three-tire-proj/environments/dev/keys/id_rsa_azure_vm.pub"
#  }